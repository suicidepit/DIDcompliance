...
export async function handleSignupComplete(client, body) {
    ...
    const fundingResult = await fundWallet(client, config.treasurySeed, config.fundingAmountXrp, newWallet.address);
    const workerRecord = {
        worker_id: workerId,
