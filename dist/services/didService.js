...
import { createDidTransaction, findDidTransactionsByWorkerId, findWorkerById, } from "../repositories/workerRepository.js";
import { submitDidSet } from "./xrplWalletService.js";
export async function handleDidSet(client, body) {
    ...
    const didResult = await submitDidSet(client, walletSeed, mockDid.data, mockDid.document, mockDid.uri);
...
function buildMockDidPayload(workerId, xrplAddress) {
